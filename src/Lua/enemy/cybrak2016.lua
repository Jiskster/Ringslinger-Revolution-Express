...
-- Created in SOC by Evertone for 72HR-UDMF, ported to Lua, optimized, and edited by MIDIMan
-- Used with permission from Evertone
...
A_RSRCybrakRandomAttack = function(actor, var1, var2)
	...
	if not Valid(actor) then
		print("WARNING: Cybrak2016's attack state was not found! Debug this: "..tostring(attackNum))
		return
	end
